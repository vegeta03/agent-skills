...
> **Tool Usage Note**: Use whatever file search, file reading, text search, directory listing, and web fetching tools are available in your environment. The core design approach remains the same regardless of tooling.
